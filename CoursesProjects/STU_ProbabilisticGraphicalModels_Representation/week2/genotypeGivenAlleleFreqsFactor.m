...
for i=1:nchoosek(numAlleles,2)+numAlleles
    alleles = genotypesToAlleles(i,:);
    alleles1 = alleles(1);
    alleles2 = alleles(2);
    if alleles1==alleles2
        genotypeFactor.val(i) = alleleFreqs(alleles1) * alleleFreqs(alleles2);
    else
        genotypeFactor.val(i) = alleleFreqs(alleles1) * alleleFreqs(alleles2)*2;
    end
